---
title: "Art Collab 2026: Disaster Preparedness, Response and Relief"
date: 2026-04-26
draft: false
description: ""
...
- Artwork must be submitted to the email address {{< cloakemail display="curator at storySeedLibrary.org" address="curator@storySeedLibrary.org" >}} with the subject "SOLARPUNK ART 2026" A brief description of the work would be appreciated.
- Submitted artwork should be licensed under [Creative Commons BY 4.0](/tags/cc-by-4.0) or [Creative Commons BY-SA 4.0](/tags/cc-by-sa-4.0). You can learn more about them [here](https://creativecommons.org/share-your-work/cclicenses/).
- Submitted artwork may be included in a livestream on the main channel and video on the side channel, as well as being published on [Tumblr](https://andrew-ism.tumblr.com/) and on Story Seed Library. By submitting artwork, you consent to your work being shared in this manner with due credit. We reserve the right to decline submissions.
...
- **Solidarity, not charity** - no matter where in the world the disaster happens, we are not unaffected or above it. [Mutual aid](https://en.wikipedia.org/wiki/Mutual_aid) teaches us to see ourselves as a part of the helping network, not just an external actor sending used clothes. Avoid [voluntourism](https://en.wikipedia.org/wiki/International_volunteering#Voluntourism_(aka_volunteer_tourism)).
...
- [Cadus](https://www.cadus.org/en/) - a disaster relief organization providing medical and technical support, with their own Crisis Response Makerspace.
- [Tolocar](https://tolocar.org/en/) from Ukraine - mobile makerspaces running workshops and helping people rebuild. Part of [Appropedia](https://www.appropedia.org/), the sustainability wiki! [Tolocar on Appropedia](https://www.appropedia.org/Tolocar).
- [Safecast](https://safecast.org/) - a citizen science project creating radiation maps founded after the [Fukushima Daiichi disaster](https://en.wikipedia.org/wiki/Fukushima_nuclear_accident). Comes with a volunteer-created [world map](https://map.safecast.org/).
- [Hermes Radio](https://hermes.radio/) - a low-energy radio communication project from the Amazon Rainforest created by [Rhizomatica](https://www.rhizomatica.org/). ([article with videos](https://www.rhizomatica.org/hermes/)).
- [Communitere](https://web-wp.archive.org/web/20220203043821/https://communitere.org/) (archived page) - a network of disaster relief tool libraries from Haiti, Nepal and Philippines giving people the agency and means to rebuild. ([video](https://www.youtube.com/watch?v=UN_J5DB3Cso)).
- [Sierra Leone Ebola Epidemic 2014](https://www.youtube.com/watch?v=JPxCUzGGDKc) - amid a deadly epidemic which caused the banking system to shut down, a group of local hackers rebuilt their systems to restore the resource flows to hospitals and medical workers.
- [A list of communal work practices in different cultures](https://en.wikipedia.org/wiki/Communal_work) on Wikipedia including _Bayanihan_ from the Philippines or East-African _Harambee_.

### Non-fiction Books & Essays

- [A Paradise Built In Hell](https://en.wikipedia.org/wiki/A_Paradise_Built_in_Hell) by [Rebecca Solnit](https://en.wikipedia.org/wiki/Rebecca_Solnit) - how communities come together in the aftermath of disasters. Also by the same author:
  - Hope in the Dark: Untold Histories, Wild Possibilities
  - The Beginning Comes After the End: Notes on a World of Change
- [When It All Burns: Fighting Fire in a Transformed World](https://www.goodreads.com/en/book/show/218154886-when-it-all-burns) by Jordan Thomas
...
- [A Year Without Sunshine](https://www.uncannymagazine.com/article/the-year-without-sunshine/) by [Naomi Kritzer](https://en.wikipedia.org/wiki/Naomi_Kritzer), winner of Nebula Award

### Need more ideas? Applicable Story Seeds

- [Seek Shelter Immediately](/seeds/seek-shelter-immediately/)
- [The Fire Brigade](/seeds/the-fire-brigade/)
- [The Reservists](/seeds/the-reservists/)
- [The Henchmen](/seeds/the-henchmen/)
- [The Expedition](/seeds/the-expedition/)
...
### Andrevism videos
  ...
  - [How to Build a Radical Community](https://www.youtube.com/watch?v=1-Xl6dhDV3Q)

## Previous Collabs

- [2025: Life of Learning](/pages/andrewisms-art-collab-2025/) on [Tumblr](https://andrew-ism.tumblr.com/post/788704934138937344/solarpunk-art-2025-life-of-learning) and on [YouTube](https://www.youtube.com/watch?v=sIgsf2Absi0)
...
Background art by [Scandinavian101](/authors/scandinavian101/)